const level1 = new Level(
  [
    new Chicken(600), new Chicken(1900), new Chicken(900),
    new Chicken(700), new Chicken(1700), new Chicken(1200),
    new Chicken(2500), new Chicken(2700), new Chicken(2100),
    new Chicken(1500), new Chick(600), new Chick(800),
    new Chick(1350), new Chick(1000), new Chick(2000),
    new Chick(1850), new Chick(1650), new Chick(2100),
    new Chick(1450), new Chick(1250), new Endboss(),
  ],
  [new Clouds(0), new Clouds(720), new Clouds(1440), new Clouds(2160), new Clouds(2880), new Clouds(3600)],
  [
  ...
  [
    new Bottles(200), new Bottles(600), new Bottles(1000), new Bottles(1500), new Bottles(2100)
  ],
  [
    new Coins(400, 200), new Coins(1000, 250), new Coins(1300, 300), new Coins(2200, 200), new Coins(2500, 250)
  ]
